...
public class NotionConfig {
    ...
    public String NOTION_INGREDIENT_DB_ID = System.getenv("NOTION_INGREDIENT_DB_ID");
    public String NOTION_RECIPE_DB_ID = System.getenv("NOTION_RECIPE_DB_ID");
    public String OPENAI_API_KEY = System.getenv("OPENAI_API_KEY");
    public String LOG_LEVEL = System.getenv("LOG_LEVEL");
